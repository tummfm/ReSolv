...
# sys.argv[1] -> defines the visible device
# sys.argv[2] -> defines the seed. We used 7 for the training of the model
# sys.argv[3] -> defines the start of the dataset subset
# sys.argv[4] -> defines the end of the dataset subset
# sys.argv[5] -> defines the model to be used (U_vac or U_wat)
...
if choose_model == 'U_vac':
    ...
    vac_model_path = (
        path_to_project + 'FreeEnergy_Publication/examples/FreeEnergyScripts/savedTrainers/261023_QM7x_Nequip_Nequip_QM7x_'
...
dataset_for_failed_U_vac = [91, 112, 126, 147, 150, 210, 243, 302, 310, 380, 382, 395, 422, 456, 458, 479, 549]
dataset_for_failed_U_wat = [30, 190, 280, 294, 420]
dataset_for_failed_molecules = dataset_for_failed_U_vac + dataset_for_failed_U_wat
...
# Iterate over molecules and generate trajectories
counter = 0

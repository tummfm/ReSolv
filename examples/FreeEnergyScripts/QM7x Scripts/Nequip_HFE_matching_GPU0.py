...
if __name__ == '__main__':
    ...
    data_indices = train_dataset_389 = [4, 24, 25, 35, 53, 56, 58, 68, 74, 100, 122, 130, 143, 144, 151, 152, 158, 162, 164, 174, 176, 181, 187, 188, 205, 206,
 ...
 383, 392, 396, 380, 397, 404, 465, 513]
    ...
    exclusion_list = [91, 112, 126, 147, 150, 210, 243, 302, 310, 380, 382, 395, 422, 456, 458, 479, 549, 420]
    no_confs = 1
    ...
    val_ratio = 0.051     # Yields 39 samples for validation
    ...
    id_num = ("Nequip_HFE_matching_date"+str(date)+"_iL" + str(initial_lr) + "_lrd" + str(lr_decay) + "_epochs" +
              str(num_epochs) + '_batch_size' + str(batch_size))

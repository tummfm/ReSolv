...
class PropagationBase(max_likelihood.MLETrainerTemplate):
    ...
    def _init_statepoint_HFE(self, reference_state, energy_fn_template,
        ...
        if initialize_traj:
            ...
            if model_type == "U_vac":
                # with open(f"precomputed_trajectories/load_traj_{Mol}", "wb") as file:
                # with open(f"precomputed_trajectories/220ps_load_traj_{Mol}", "wb") as file:
                # with open(f"precomputed_trajectories/250_50ps_load_traj_{Mol}", "wb") as file:
                # with open(f"precomputed_trajectories/3300ps_load_traj_{Mol}", "wb") as file:
                # with open(f"precomputed_trajectories/iL1emin7_lrd1emin1_1000epochs_250ps_load_traj_{Mol}", "wb") as file:
                # with open(f"precomputed_trajectories/iL1emin6_lrd1emin2_1200epochs_250ps_load_traj_{Mol}", "wb") as file:
                with open(f"precomputed_trajectories/4300_300ps_load_traj_{Mol}", "wb") as file:
                # with open(f"precomputed_trajectories/250_50ps_load_traj_{Mol}", "wb") as file:
                    dill.dump(traj_dict, file)
            elif model_type == "U_wat":
                # with open(f"precomputed_trajectories/load_wat_traj_{Mol}", "wb") as file:
                # with open(f"precomputed_trajectories/220ps_load_wat_traj_{Mol}", "wb") as file:
                # with open(f"precomputed_trajectories/250_50ps_load_wat_traj_{Mol}", "wb") as file:
                # with open(f"precomputed_trajectories/3300ps_load_wat_traj_{Mol}", "wb") as file:
                # with open(f"precomputed_trajectories/iL1emin7_lrd1emin1_1000epochs_250ps_wat_traj_{Mol}", "wb") as file:
                # with open(f"precomputed_trajectories/iL1emin6_lrd1emin2_1200epochs_250ps_wat_traj_{Mol}", "wb") as file:
                with open(f"precomputed_trajectories/4300_300ps_load_wat_traj_{Mol}", "wb") as file:
                    dill.dump(traj_dict, file)
            ...
            if model_type == "U_vac":
                # with open(f"precomputed_trajectories/load_traj_{Mol}", "rb") as file:
                ...
                # with open(f"precomputed_trajectories/load_wat_traj_{Mol}", "rb") as file:
                # with open(f"precomputed_trajectories/220ps_load_wat_traj_{Mol}", "rb") as file:

...
def dimenetpp_neighborlist_ANI1x(displacement: space.DisplacementFn,
                                 r_cutoff: float,
                                 n_species: int = 100,
                                 positions_test: jnp.ndarray = None,
                                 neighbor_test: partition.NeighborList = None,
    ...
    Compared to original function added max_edges and max_angles. By precomputing
    and passing these, we can improve performance.
    ...
    Args:
        ...
        max_triplet_multiplier: Multiplier for initial estimate of maximum
                                triplets.
        max_edges: Precomputed max edges to improve performance.
        max_angles: Precomputed max angles to improve performance.
        dimenetpp_kwargs: Kwargs to change the default structure of DimeNet++.
                          For definition of the kwargs, see DimeNetPP.
    ...
    elif max_edges is not None and max_angles is not None:
        print("Use precomputed max_edges and max_angles")
        max_edges = max_edges
        max_triplets = max_angles

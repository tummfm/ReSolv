...
class wrapper_ForceMatching():
    ...
    def train(self, num_epochs, save_path):
        ...
        for i in range(num_epochs):
            ...
            best_params_path = '/home/sebastien/FreeEnergy/examples/FreeEnergyScripts/savedTrainers/'+str(save_path)+'_epoch_'+str(i+1)+'_Params.pkl'
            with open(best_params_path, 'wb') as pickle_file:
                pickle.dump(self._trainer.params, pickle_file)

        last_params_path = '/home/sebastien/FreeEnergy/examples/FreeEnergyScripts/savedTrainers/' + str(
            save_path) + '_lastParams.pkl'
        with open(last_params_path, 'wb') as pickle_file:
            pickle.dump(self._trainer.params, pickle_file)

        train_loss_path = '/home/sebastien/FreeEnergy/examples/FreeEnergyScripts/savedTrainers/'+str(save_path)+'_trainLoss.pkl'
        val_loss_path = '/home/sebastien/FreeEnergy/examples/FreeEnergyScripts/savedTrainers/' + str(save_path) + '_valLoss.pkl'
